...
def username(**user):	# creating function username
	...
	if len(midname) > 0:
		password = fname[0:2:3].lower() + midname[-1].capitalize() + fname[0:2:3].lower() + fname[2].capitalize() + lname[-2].lower() + fname[1].capitalize() + midname[0].lower() + midname[-3:2].lower()
